...
import {
  ...
  Truck, PlusCircle, FileUp, SlidersHorizontal,
} from "lucide-react";
      ...
      {articlesStockFaible.length > 0 && (
        <div className="bg-[#FFFCF4] border border-orange-100 rounded-xl p-5 mb-6 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-sm font-bold text-orange-700">Alerte de Stock Faible </p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white border border-gray-200 rounded-xl p-5">
          <div className="flex items-center gap-2 mb-4">
            ...
            <h2 className="font-bold text-[#14231F]">Activité Récente</h2>
          </div>
        ...
        <div className="bg-white border border-gray-200 rounded-xl p-5">
          <div className="flex items-center gap-2 mb-4">
            ...
            <h2 className="font-bold text-[#14231F]">Alerte de stock faible</h2>
          </div>
          <div className="space-y-4">
